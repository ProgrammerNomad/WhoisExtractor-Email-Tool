      ...
      <footer className="bg-white dark:bg-bg-secondary border-t border-border-gray mt-8">
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* About */}
            <div>
              <h3 className="text-sm font-bold text-text-dark mb-3">About</h3>
              <p className="text-xs text-text-muted">
                WhoisExtractor: Email Tool extracts email addresses from text with advanced filtering options. All processing happens locally in your browser.
              </p>
            </div>

            {/* Quick Links */}
            <div>
              <h3 className="text-sm font-bold text-text-dark mb-3">Quick Links</h3>
            ...
            {/* Support */}
            <div>
              <h3 className="text-sm font-bold text-text-dark mb-3">Support</h3>
          ...
          <div className="mt-6 pt-4 border-t border-border-gray text-center">
            <p className="text-xs text-text-muted">
              <span className="font-semibold text-brand-green">Free & Open Source</span> | 
              Licensed under MIT License | 
              <a href="https://github.com/ProgrammerNomad" target="_blank" rel="noopener noreferrer" className="text-brand-blue hover:underline ml-1">
                @ProgrammerNomad
              </a>
            </p>
            <p className="text-xs text-text-muted mt-1">
              Version 1.0.0 | Built with ❤️ using Plasmo, React & TailwindCSS
            </p>
            <p className="text-xs text-text-muted mt-1">
              Feel free to use, modify, and distribute this tool for any purpose!
            </p>
          </div>
        </div>
      </footer>
