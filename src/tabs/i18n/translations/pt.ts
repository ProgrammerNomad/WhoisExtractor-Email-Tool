...
export const pt: Translation = {
  ...
  update: {
    ...
    message: "A versão {{version}} está disponível agora.",
    description: "Recarregue a extensão para atualizar para a versão mais recente com novos recursos e melhorias.",
